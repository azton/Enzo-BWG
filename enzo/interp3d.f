...
c
      ...
      parameter (MAX_REFINE = 32, ijkn = 4103)
c
c-----------------------------------------------------------------------
c
c  arguments
...
c
               if (delf0 .eq. 0.0) then
                  delf0 = sign(1.0e-20*1.0e-5, delf1 + delf2 + delf3)
                  sprime = 1.0
               else
