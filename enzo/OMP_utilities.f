...
c
!$omp parallel
!$omp-  shared(dest, source, start1, start2, start3, end1, end2, end3)
!$omp-  shared(sstart1, sstart2, sstart3, dstart1, dstart2, dstart3)
!$omp-  private(i, j, k)
!$omp-  default(none)
!$omp do
      do k = start3, end3
...
!$omp parallel
!$omp-  shared(dest, source1, source2)
!$omp-  shared(start1, start2, start3, end1, end2, end3)
!$omp-  shared(sstart1, sstart2, sstart3, dstart1, dstart2, dstart3)
!$omp-  shared(weight1, weight2, irefine, ivel_shift)
!$omp-  private(i, j, k, fact1, fact2)
!$omp-  default(none)
