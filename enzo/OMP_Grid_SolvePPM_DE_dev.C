...
#pragma omp parallel private(k) shared(NumberOfSubgrids, SubgridFluxes, GridGlobalStart, CellWidthTemp, GravityOn, NumberOfColours, colnum, status, Pressure) default(none)
#else
#pragma omp parallel private(k) shared(GridDimension, NumberOfSubgrids, SubgridFluxes, GridGlobalStart, CellWidthTemp, GravityOn, NumberOfColours, colnum, status, Pressure) default(none)
#endif
  {
...
#pragma omp for schedule(dynamic)
      for (k = 0; k < GridDimension[2]; k++) {
        status[k] = this->xEulerSweep(k, NumberOfSubgrids, SubgridFluxes, 
			      ...
			      NumberOfColours, colnum, Pressure);
      } // ENDFOR k
...
#ifdef INTEL_OMP_SYNTAX
#pragma omp parallel private(i) shared(NumberOfSubgrids, SubgridFluxes, GridGlobalStart, CellWidthTemp, GravityOn, NumberOfColours, colnum, status, Pressure) default(none)
#else
#pragma omp parallel private(i) shared(GridDimension, NumberOfSubgrids, SubgridFluxes, GridGlobalStart, CellWidthTemp, GravityOn, NumberOfColours, colnum, status, Pressure) default(none)
#endif
  {
...
#ifdef INTEL_OMP_SYNTAX
#pragma omp parallel private(j) shared(NumberOfSubgrids, SubgridFluxes, GridGlobalStart, CellWidthTemp, GravityOn, NumberOfColours, colnum, status, Pressure) default(none)
#else
#pragma omp parallel private(j) shared(GridDimension, NumberOfSubgrids, SubgridFluxes, GridGlobalStart, CellWidthTemp, GravityOn, NumberOfColours, colnum, status, Pressure) default(none)
#endif
  {
