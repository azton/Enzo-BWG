...
c
      if (ndim .lt. 1 .or. ndim .gt. 3) then
         ...
         CALL f_error("interpolate.src",64)
      endif
c
...
c
      if (imethod .lt. 0 .or. imethod .gt. 4) then
         ...
         CALL f_error("interpolate.src",71)
      endif
c
...
c
 ...
 1030       format("INTERPOLATE: ERROR pstart =", i5, "  pend =", i5,
     &             "  pdims =", i5, "  i =", i2)
            CALL f_error("interpolate.src",82)
         endif
      enddo
c
...
c
     ...
     &                 " refine(i) =", refine(i), " i =", i
            CALL f_error("interpolate.src",92)
         endif
      enddo
c
c  A) ThirdOrderA
...
c
         if (ndim .ne. 3) then
            ...
            CALL f_error("interpolate.src",185)
         endif
c
