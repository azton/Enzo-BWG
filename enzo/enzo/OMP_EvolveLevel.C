...
#endif
    printf("SubcycleSkipflag =%"ISYM"\n", cycle % RebuildHierarchyCycleSkip);
    printf("RebuildHierarchyCycleSkip[%"ISYM"] = %"ISYM"\n", level,RebuildHierarchyCycleSkip );
    if ((dtThisLevelSoFar < dtLevelAbove) && 
            (cycle % RebuildHierarchyCycleSkip == 0)) {
