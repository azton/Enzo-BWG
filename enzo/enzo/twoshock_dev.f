...
c
      integer*8 gravity, i1, i2, idim, idual, ipresfree, j1, j2, jdim
      real*8    dt, eta1, gamma, pmin
      real*8    dls(idim,jdim),     drs(idim,jdim),    pbar(idim,jdim),
...
c
      integer*8 i, j, n
      real*8     cl(ijkn),    cr(ijkn), dpdul(ijkn), dpdur(ijkn),
     &         ps(ijkn),    ubl(ijkn),   ubr(ijkn),
     &         qa      ,     zl(ijkn),    zr(ijkn)

      integer*8 itok, jjj
      integer*8 mask(ijkn), jfail(ijkn)
      real*8    old_ps(ijkn), delta_ps(ijkn)
      real*8    fails(ijkn)
